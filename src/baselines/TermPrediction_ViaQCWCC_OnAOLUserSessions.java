...
public class TermPrediction_ViaQCWCC_OnAOLUserSessions {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		System.out.println("Done with populating train/test for user sessions...\nGoing to load taskList now...");
		loadTaskListBuiltByQCWCC();
		System.out.println("Loaded the taskList...we have the taskList with "+taskList+" trees...\nGoing to populate BoW in taskList");
	...
	public static void loadTaskListBuiltByQCWCC() throws IOException, ClassNotFoundException
	{
		FileInputStream fis = new FileInputStream("data/taskListObtainedViaQCWCC");
        ObjectInputStream ois = new ObjectInputStream(fis);
        taskList = (ArrayList<Tree>) ois.readObject();
        ois.close();
	}
